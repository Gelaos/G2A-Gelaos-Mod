...
INSTANCE GelaosModHelper (NPC_DEFAULT)
{
	//-------- primary data --------
	name			= "Gelaos Mod Helper";
	Npctype			= NPCTYPE_FRIEND;
	guild			= GIL_NONE;
	level			= 999;			// real 15, aber 999 damit er nicht vor dem BrĂĽckegolem flieht!
	voice			= 5;
	id				= 5000;
	flags			= 0;
	...
	Npc_SetTalentSkill	(self, NPC_TALENT_PICKLOCK, 		1); //hĂ¤ngt ab von DEX (auf Programmebene)
	Npc_SetTalentSkill	(self, NPC_TALENT_SNEAK, 			1);
	Npc_SetTalentSkill	(self, NPC_TALENT_ACROBAT, 			0);
	
	Npc_SetTalentSkill	(self, NPC_TALENT_PICKPOCKET, 		1);	//hĂ¤ngt ab von DEX (auf Scriptebene)
	...
	B_SetFightSkills (self, 100); //Grenzen fĂĽr Talent-Level liegen bei 30 und 60
